...
export default function Navbar() {
    ...
    return (
        <article class="navbar">
            ...
            <h3>Download</h3>
            <a href={Resume} download><button class="resume-btn">Resume</button></a>

            <h3>Connect Us</h3>
            <div class="connect-us">
                <a href="tel:7703833281" target="_blank"><img src={Img2} id="phone" alt="phone-logo"></img></a>
                <a href="https://wa.me/917703833281" target="_blank" class="whatupp"><img src={Img3} alt="whatup-logo"></img></a>
                <a href="mailto:RAVIRA_209098@SAITM.ORG" target="_blank" class="gmail"><img id="gmail" src={Img4} alt="gmail-logo"></img></a>
            </div>
        </article>
    )
}