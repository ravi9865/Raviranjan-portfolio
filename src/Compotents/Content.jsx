                ...
                <div className="projects">
                    ...
                    <div className="project-card">
                        <div className="child-card card-2">
                            ...
                            <div className="anchor-child">
                                <a href="https://firefox-search-browser-2023.netlify.app/" className="view-child" target="_blank" rel="noopener noreferrer">View</a>
                                <a href="https://github.com/ravi9865/Firefox-Browser-Clone-with-search-Functionality.git" className="code-child" target="_blank" rel="noopener noreferrer">Code</a>
                            </div>
                        </div>
                    </div>
                    <div className="project-card">
                        <div className="child-card card-3">
                            ...
                            <div className="anchor-child">
                                <a href="https://spotify-web-2023.netlify.app/" className="view-child" target="_blank" rel="noopener noreferrer">View</a>
                                <a href="https://spotify-web-2023.netlify.app/" target="_blank" className="code-child" rel="noopener noreferrer">Code</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="projects">
                    <div className="project-card">
                        <div className="child-card card-4">
                            ...
                            <div className="anchor-child">
                                <a href="https://ravi-sharma-dashboard-2023.netlify.app/" className="view-child" target="_blank" rel="noopener noreferrer">View</a>
                                <a href="https://github.com/ravi9865/Responsive-Dashboard.git" className="code-child" target="_blank" rel="noopener noreferrer">Code</a>
                            </div>
                        </div>
                    </div>
                    <div className="project-card">
                        <div className="child-card card-5">
                            ...
                            <div className="anchor-child">
                                <a href="https://shaadi-home-page-clone-2023.netlify.app/" className="view-child" target="_blank" rel="noopener noreferrer">View</a>
                                <a href="https://github.com/ravi9865/shaadi.com-clone-home-page.git" className="code-child" target="_blank" rel="noopener noreferrer">Code</a>
                            </div>
                        </div>
                    </div>
                    <div className="project-card">
                        <div className="child-card card-6">
                            ...
                            <div className="anchor-child">
                                <a href="https://wheather-forecast-app-2022.netlify.app/" className="view-child" target="_blank" rel="noopener noreferrer">View</a>
                                <a href="https://github.com/ravi9865/wheather-forecast-app.git" className="code-child" target="_blank" rel="noopener noreferrer">Code</a>
                            </div>
                        </div>
                    </div>
                </div>
